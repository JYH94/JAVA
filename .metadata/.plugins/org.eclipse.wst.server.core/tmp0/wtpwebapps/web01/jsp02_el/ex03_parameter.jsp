...
\${empty_ param.password} => ${empty param.password}

3. pageContext
=> Jsp 페이지에 대한 정보를 저장하고 있는 객체(=pageScope)
=> 기본객체를 return 하는 메서드를 제공
* 요청 URL : \${request.requestURL} X -> \${pageContext.request.requestURL } O
* 요청 URI : \${request.requestURL} X -> \${pageContext.request.requestURI } O
