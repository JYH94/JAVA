 ...
 * Generated at: 2024-01-16 03:09:28 UTC
...
// => request 영역에 속성(Attribute) 2개 만들고 활용 Test
   ...
   request.setAttribute("num2", 456);
      ...
      out.write("	=> 호출, 우선순위\r\n");
      out.write("	=> el 내부에 변수명이 오면 JSTL의 변수명, 속성(Attribute) 의 이름으로 인식\r\n");
      out.write("<b>\r\n");
      out.write("	${name} => ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${name}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\r\n");
      out.write("	=> 가까운곳부터 찾아감 (page - request - session - application)\r\n");
      out.write("	=> 동일한 속성명을 사용한 경우에 모두 구별해서 출력하려면\r\n");
      out.write("	   속성명을 붙여서 적용 (앞에 영역_Scope 객체가 생략된것임)\r\n");
      out.write("	   ${pageScope_name} => ");
      ...
      out.write("\r\n");
      out.write("	   ${applicationScope_name} => ");
      ...
      out.write("\r\n");
      out.write("	=> 그러나 영역(Scope)을 붙여주는것이 효율적이다. (direct 로 인식)\r\n");
      out.write("<hr>\r\n");
	...
	int n2 = (int)request.getAttribute("num2"); 
      ...
      out.write("\r\n");
      out.write(" \r\n");
      out.write("3.3) Parameter Test : Java\r\n");
      out.write("=> 쿼리스트링으로 Test : ~/jsp02_el/ex02_getAttribute.jsp/num1=200&num2=789\r\n");
	...
	n2 = Integer.parseInt(request.getParameter("num2"));
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("3.4) Parameter Test : EL\r\n");
