...
<form action="mCheckList" method="get">
      ...
      <!-- ------------------------------------------------------------------------ -->
        <input type="checkbox" name="check" class="clear check" value="1" ${ck1 ? 'checked' : ''}>Business&nbsp;
        <input type="checkbox" name="check" class="clear check" value="2" ${ck2 ? 'checked' : ''}>static&nbsp;
        <input type="checkbox" name="check" class="clear check" value="3" ${ck3 ? 'checked' : ''}>칭찬해조&nbsp;
        <input type="checkbox" name="check" class="clear check" value="4" ${ck4 ? 'checked' : ''}>카톡으로얘기하조&nbsp;
        <input type="checkbox" name="check" class="clear check" value="7" ${ck5 ? 'checked' : ''}>칠면조&nbsp;
