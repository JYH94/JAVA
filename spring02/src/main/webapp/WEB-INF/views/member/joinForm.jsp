...
function idDupCheck() {
	...
	// 2) 서버로 id 확인요청 -> 결과는 팝업창
		...
		window.open(url,'_blank','width=400,height=300,resizable=yes,scrollbars=yes,toolbar=no,menubar=yes'); // 팝업창
	}
	// 3) id, selectOne 결과
}
...
<body>
	...
	<form action="join" method="post">
		<table>
			...
			<tr height="40">
				<td bgcolor="GreenYellow"><label for="password2">PW 확인
				</label></td>
			...
			<tr>
				...
				<td><input type="submit" id="submitTag" value="가입"
                 ...
                 - submit 정지 : submit 이벤트를 무효화 해야함 (return false 또는 이벤트.preventDefault())  -->
					...
					<button type="button" onclick="inCheck()">ButtonTest</button></td>
			</tr>
		</table>
	</form>
	<br>
	...
	<!-- Button Test
            ...
            => 단, type 속성을 선택하면 (button, reset, submit 등) 속성에 맞게 실행됨
               ...
               Enter_Key : form 내부에서는 누르면 submit 진행
               -->
