...
=> 2) 응답상태코드(404, 500 등): web.xml 
	-> 오류 종류(404,500...)에 따라 출력되는 페이지를 다르게 설정할 수 있다.
...
<hr>
Test 1) NullPointerException : Exception Type
* Country: <%=request.getParameter("country").toUpperCase() %>
<!-- null 에 toUpperCase() 하게 되면 nullpointException 에러 발생( 500번 ) -->

Test 2) NumberFormatException : 상태코드 500
* Number: <%=Integer.parseInt(request.getParameter("country")) %>

Test 3) ArithmeticException : Exception Type
   => by Zero
   123/0 = <%= 123/0 %>
